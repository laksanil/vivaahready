    ...
    <div className="max-w-md w-full px-4 sm:px-0">
      <div className="bg-white rounded-2xl shadow-xl p-5 sm:p-8">
        ...
        <div className="mt-6">
          ...
          >
            <span>Don&apos;t have Gmail? Sign in with email</span>
          ...
          <>
            ...
            <div className="relative my-6">
              ...
              <div className="relative flex justify-center text-sm">
                <span className="px-2 bg-white text-gray-400">Email Sign In</span>
              </div>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <button
                type="submit"
                disabled={loading}
                className="w-full py-3 px-4 bg-gray-100 text-gray-700 font-medium rounded-lg hover:bg-gray-200 disabled:opacity-50 transition-colors flex items-center justify-center"
              >
                {loading ? (
                  <>
            ...
            <p className="text-center text-xs text-gray-500 mt-3">
              Email sign in requires email verification
            </p>
          </>
        )}
...
export default function LoginPage() {
  return (
    <div className="min-h-[calc(100vh-200px)] flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8 bg-gradient-to-br from-white via-silver-50 to-silver-100">
