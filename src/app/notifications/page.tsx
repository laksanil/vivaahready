...
function isAdminMessageNotification(type: string): boolean {
  return type === 'support_admin_reply'
}

function isUserMessageNotification(type: string): boolean {
  return type === 'support_user_message' || type === 'feedback_submitted'
}
