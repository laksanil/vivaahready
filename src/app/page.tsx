            ...
            const steps = [
              {
                ...
                body: 'Create your profile and preferences. Free to register. Add deal-breakers and match preferences.',
              },
              {
                title: 'Find Matches (Mutual Preferences)',
                body: 'See curated matches where both sides\' preferences and deal-breakers align. Photos, names, and contact details stay hidden at this stage.',
              },
              {
                title: 'Express Interest (Free)',
                body: 'Like a match? Express interest instantly. This is free and keeps connections mutual and respectful.',
              },
              {
                title: 'Verify to Proceed',
                body: 'Ready to take a connection forward? Complete verification to keep the community genuine and move forward with serious connections.',
              },
              {
                title: 'Connect',
                body: 'When both sides are interested, you connect. Messaging opens and contact details are revealed only after mutual interest.',
              },
            ]
