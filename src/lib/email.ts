...
export async function sendCompleteProfileNudgeEmail(email: string, firstName: string) {
...
<head>
  <meta charset="utf-8">
  <meta name="viewport" content="width=device-width, initial-scale=1.0">
  <title>Complete Your Profile on VivaahReady</title>
</head>
<body style="margin: 0; padding: 0; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, 'Helvetica Neue', Arial, sans-serif; background-color: #f5f5f5;">
  <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%" style="background-color: #f5f5f5;">
    <tr>
      <td style="padding: 40px 20px;">
        <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%" style="max-width: 600px; margin: 0 auto; background-color: #ffffff; border-radius: 12px; overflow: hidden; box-shadow: 0 4px 6px rgba(0, 0, 0, 0.1);">
          ...
          <tr>
            <td style="padding: 40px;">
              <h2 style="margin: 0 0 24px 0; color: #1f2937; font-size: 24px; text-align: center; line-height: 1.4;">
                We've Upgraded VivaahReady!
              </h2>
              ...
              <p style="margin: 0 0 20px 0; color: #4b5563; font-size: 16px; line-height: 1.6;">
                We have some exciting news! VivaahReady has been completely redesigned with a brand-new experience — better matching, a cleaner interface, and new features to help you find your perfect match faster.
              </p>

              <!-- Incomplete Profile Notice -->
              <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%" style="margin: 24px 0; background: linear-gradient(135deg, #fef3c7 0%, #fde68a 100%); border-radius: 12px; border: 1px solid #f59e0b;">
                <tr>
                  <td style="padding: 24px; text-align: center;">
                    <p style="margin: 0 0 8px 0; color: #92400e; font-size: 18px; font-weight: 700;">Your Profile Isn't Complete Yet</p>
                    <p style="margin: 0; color: #a16207; font-size: 15px; line-height: 1.6;">
                      To start appearing in matches and discover compatible profiles, please log in and complete your profile details, including uploading at least one photo.
                    </p>
                  </td>
                </tr>
              </table>
              ...
              <!-- Steps -->
              <h3 style="margin: 28px 0 16px 0; color: #1f2937; font-size: 20px; font-weight: 600;">Just 3 Simple Steps</h3>
                  ...
                  <td style="padding: 10px 0;">
                    <table role="presentation" cellspacing="0" cellpadding="0" border="0">
                      <tr>
                        ...
                        <td style="padding-left: 12px;">
                          <p style="margin: 0; color: #1f2937; font-size: 15px; font-weight: 600;">Log in to your account</p>
                          <p style="margin: 4px 0 0 0; color: #6b7280; font-size: 14px; line-height: 1.5;">Visit vivaahready.com and sign in with the same email you registered with.</p>
                        </td>
                      </tr>
                    </table>
                  </td>
                  ...
                  <td style="padding: 10px 0;">
                    <table role="presentation" cellspacing="0" cellpadding="0" border="0">
                      <tr>
                        ...
                        <td style="padding-left: 12px;">
                          <p style="margin: 0; color: #1f2937; font-size: 15px; font-weight: 600;">Complete your profile details</p>
                          <p style="margin: 4px 0 0 0; color: #6b7280; font-size: 14px; line-height: 1.5;">Fill in all the remaining sections — the more complete your profile, the better your matches.</p>
                        </td>
                      </tr>
                    </table>
                  </td>
                  ...
                  <td style="padding: 10px 0;">
                    <table role="presentation" cellspacing="0" cellpadding="0" border="0">
                      <tr>
                        ...
                        <td style="padding-left: 12px;">
                          <p style="margin: 0; color: #1f2937; font-size: 15px; font-weight: 600;">Upload at least one photo</p>
                          <p style="margin: 4px 0 0 0; color: #6b7280; font-size: 14px; line-height: 1.5;">Profiles with photos get <strong>significantly more interest</strong> from other members. Don't miss out!</p>
                        </td>
                      </tr>
                    </table>
                  </td>
              ...
              <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%" style="margin: 32px 0;">
                <tr>
                  <td style="text-align: center;">
                    <a href="https://vivaahready.com/dashboard" style="display: inline-block; background: linear-gradient(135deg, #dc2626 0%, #b91c1c 100%); color: #ffffff; text-decoration: none; padding: 16px 40px; border-radius: 8px; font-weight: 600; font-size: 16px; box-shadow: 0 4px 14px rgba(220, 38, 38, 0.4);">
                      Complete My Profile
                    </a>
                  </td>
                </tr>
              ...
              <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%">
                <tr>
                  <td style="padding: 8px 0; color: #4b5563; font-size: 15px; line-height: 1.6;">
                    <span style="color: #dc2626; font-weight: bold; margin-right: 8px;">&#10003;</span> <strong>Smarter mutual matching</strong> based on your preferences
                  </td>
                </tr>
                <tr>
                  <td style="padding: 8px 0; color: #4b5563; font-size: 15px; line-height: 1.6;">
                    <span style="color: #dc2626; font-weight: bold; margin-right: 8px;">&#10003;</span> <strong>Privacy-first design</strong> — your info is only shared with mutual matches
                  </td>
                </tr>
                <tr>
                  <td style="padding: 8px 0; color: #4b5563; font-size: 15px; line-height: 1.6;">
                    <span style="color: #dc2626; font-weight: bold; margin-right: 8px;">&#10003;</span> <strong>Verified profiles</strong> for a safer experience
                  </td>
                </tr>
                <tr>
                  <td style="padding: 8px 0; color: #4b5563; font-size: 15px; line-height: 1.6;">
                    <span style="color: #dc2626; font-weight: bold; margin-right: 8px;">&#10003;</span> <strong>Clean, modern interface</strong> — completely redesigned
                  </td>
                </tr>
              </table>
              ...
              <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%" style="margin-top: 32px;">
                <tr>
                  <td>
                    <p style="margin: 0 0 8px 0; color: #4b5563; font-size: 15px;">Warm regards,</p>
                    <p style="margin: 0; color: #1f2937; font-size: 15px; font-weight: 600;">The VivaahReady Team</p>
                  </td>
                </tr>
              </table>
            </td>
...
`
  ...
  return sendEmail({
    to: email,
    subject: "We've Upgraded VivaahReady — Complete Your Profile & Start Matching!",
    html,
  })
}
