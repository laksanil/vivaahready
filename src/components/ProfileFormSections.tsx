  ...
  return (
    <>
      ...
      <div className="grid grid-cols-2 gap-4">
        ...
        <div>
          <label className="block text-sm font-medium text-gray-700 mb-1">Any Disability *</label>
  ...
  return (
    <>
      ...
      <div className="grid grid-cols-2 gap-4">
        ...
        <div>
          <label className="block text-sm font-medium text-gray-700 mb-1">Grew Up In</label>
      ...
      <div className="grid grid-cols-2 gap-4">
        <div>
          <label className="block text-sm font-medium text-gray-700 mb-1">Lives with Family?</label>
        ...
        <div>
          <label className="block text-sm font-medium text-gray-700 mb-1">Family Location</label>
...
export function ReligionSection({ formData, handleChange }: SectionProps) {
  return (
    <>
      ...
      <div className="grid grid-cols-3 gap-4">
        <div>
          <label className="block text-sm font-medium text-gray-700 mb-1">Birth Country</label>
      ...
      <div className="grid grid-cols-3 gap-4">
        <div>
          <label className="block text-sm font-medium text-gray-700 mb-1">Raasi</label>
        ...
        <div>
          <label className="block text-sm font-medium text-gray-700 mb-1">Doshas</label>
  ...
  return (
    <>
      <div className="grid grid-cols-2 gap-4">
        ...
        <div>
          <label className="block text-sm font-medium text-gray-700 mb-1">Preferred Height Range</label>
      ...
      <div className="grid grid-cols-2 gap-4">
        <div>
          <label className="block text-sm font-medium text-gray-700 mb-1">Preferred Income (Minimum)</label>
      ...
      <div className="grid grid-cols-2 gap-4">
        <div>
          <label className="block text-sm font-medium text-gray-700 mb-1">Preferred Diet</label>
        ...
        <div>
          <label className="block text-sm font-medium text-gray-700 mb-1">Preferred Caste</label>
      ...
      <div className="grid grid-cols-2 gap-4">
        <div>
          <label className="block text-sm font-medium text-gray-700 mb-1">Preferred Gothra</label>
      ...
      <div>
        <label className="block text-sm font-medium text-gray-700 mb-1">Ideal Partner Description</label>
