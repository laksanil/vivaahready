...
// Pages that are part of profile creation flow — no sidebar
const PROFILE_CREATION_PATHS = ['/profile/complete', '/profile/photos']

export function isSidebarPage(pathname: string | null): boolean {
  if (!pathname) return false
  if (PROFILE_CREATION_PATHS.some(p => pathname === p || pathname.startsWith(p + '/'))) return false
